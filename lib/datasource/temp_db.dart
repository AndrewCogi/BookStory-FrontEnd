...
class TempDB{
  static List<Book> bookList = <Book>[
    Book(
      ...
      writer: '김정민',
      bookPage: 32,
      categoryAge: CategoryType.AGE_4_PLUS,
      categoryType: [CategoryType.FAIRY_TALE, CategoryType.CREATIVE],
      playTime: 2 * 60 + 17,
    ...
    Book(
      ...
      categoryType: [CategoryType.LIFE_STYLE, CategoryType.HABITS],
      playTime: 6 * 60 + 59,
    ...
    Book(
      ...
      writer: '정란희',
      bookPage: 40,
      categoryAge: CategoryType.AGE_8_PLUS,
      categoryType: [CategoryType.FAIRY_TALE, CategoryType.CREATIVE],
      playTime: 8 * 60 + 44,
    ...
    Book(
      ...
      writer: '이현',
      bookPage: 36,
      categoryAge: CategoryType.AGE_6_PLUS,
      categoryType: [CategoryType.FAIRY_TALE, CategoryType.CREATIVE],
      playTime: 4 * 60 + 1,
