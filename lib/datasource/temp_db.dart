...
그리고 현재 있는 bookType은 삭제하기. booktype처럼 출력되도록 하기 위해서
constants.dart에 값들 추가해서 구성하기
??/?? 으로 categoryType이 나뉘다 보니, 글씨가 화면을 넘어가는 문제 발생. 해결해야 함.
-> 하나만 출력하게 하고, 자세한 정보를 볼 때 다 보여줄 것인지?
popular books도 tempDB에서 하나로 합치기.
*/
...
class TempDB{
  static List<Book> bookList = <Book>[
    Book(
      ...
      writer: '김정민',
      bookType: '4+ | 창작 | 32p',
      categoryType: [CategoryType.age4plus, CategoryType.creative],
      playTime: '02:17',
      favorite: 2739,
      rate: 4.5,
      playCount: 36082,
    ...
    Book(
      ...
      categoryType: [CategoryType.upto6age, CategoryType.living],
      playTime: '06:59',
      favorite: 63427,
      rate: 4.5,
      playCount: 6342,
    ...
    Book(
      ...
      categoryType: [CategoryType.age8plus, CategoryType.creative],
      playTime: '08:44',
      favorite: 55126,
      rate: 4.5,
      playCount: 5512,
    ...
    Book(
      ...
      categoryType: [CategoryType.age4plus, CategoryType.society, CategoryType.culture],
      playTime: '08:24',
      favorite: 47542,
      rate: 4.5,
      playCount: 4754,
    ...
    Book(
      ...
      categoryType: [CategoryType.upto6age, CategoryType.learning],
      playTime: '05:02',
      favorite: 45671,
      rate: 4.5,
      playCount: 4567,
