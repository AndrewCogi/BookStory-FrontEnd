...
class NaturalScienceBookListView extends StatefulWidget {
  const NaturalScienceBookListView({Key? key, this.callBack}) : super(key: key);

  final Function(Book)? callBack;
  @override
  NaturalScienceBookListViewState createState() => NaturalScienceBookListViewState();
}

class NaturalScienceBookListViewState extends State<NaturalScienceBookListView>
    ...
    return Padding(
      ...
      child: FutureBuilder<List<Book>>(
        future: Provider.of<AppDataProvider>(context, listen: false)
            .getBooksByCategory([CategoryType.natural,CategoryType.science], 10),
