...
class LifeStyleHabitsBookListView extends StatefulWidget {
  const LifeStyleHabitsBookListView({Key? key, this.callBack}) : super(key: key);

  final Function(Book)? callBack;
  @override
  LifeStyleHabitsBookListViewState createState() => LifeStyleHabitsBookListViewState();
}

class LifeStyleHabitsBookListViewState extends State<LifeStyleHabitsBookListView>
    ...
    return Padding(
      ...
      child: FutureBuilder<List<Book>>(
        future: Provider.of<AppDataProvider>(context, listen: false)
            .getBooksByCategory([CategoryType.lifeStyle,CategoryType.habits], 10),
