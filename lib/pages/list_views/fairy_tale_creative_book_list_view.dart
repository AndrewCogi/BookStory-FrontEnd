...
class FairyTaleCreativeBookListView extends StatefulWidget {
  const FairyTaleCreativeBookListView({Key? key, this.callBack}) : super(key: key);

  final Function(Book)? callBack;
  @override
  FairyTaleCreativeBookListViewState createState() => FairyTaleCreativeBookListViewState();
}

class FairyTaleCreativeBookListViewState extends State<FairyTaleCreativeBookListView>
    ...
    return Padding(
      ...
      child: FutureBuilder<List<Book>>(
        future: Provider.of<AppDataProvider>(context, listen: false)
            .getBooksByCategory([CategoryType.fairyTale,CategoryType.creative], 10),
